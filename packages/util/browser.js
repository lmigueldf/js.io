...
$.onEvent = function (el, name, f) {
    ...
    if (el.addEventListener) {
        el.addEventListener(name, handler, ( name == 'touchstart' ? {passive: true} : false));
    } else {
        handler = function (e) {
...
$.stopEvent = function (e) {
    if (e) {
        ...
        if (e.preventDefault && (e.type != 'touchstart' && e.type != 'mousewheel' && e.type != 'touchmove')) e.preventDefault();
    }
}
